...
class MainWindow(QMainWindow):
    def __init__(self, pic_cam1=None, pic_cam2=None, pic_cam3=None, stage_cam1=None, stage_cam2=None, stage_cam3=None):
        super().__init__()
    ...
    def display_on_gui(self):
        ...
        if (time.time()-self.time_start_led>2.5) :
                ...
                if data is not None:
                    for i in range(len(data)):
                        if i==0:
                            ...
                            x_new = x_new_move+  self.L * math.cos(angle_radiant)
                            y_new = y_new_move+  self.L * math.sin(angle_radiant)
...
def camera_Basler_multi(pic_cam1, pic_cam2, pic_cam3, trigger_cam1, trigger_cam2, trigger_cam3):
    id_cam1=0
    cam1=0
    id_cam2=0
    cam2=0
...
def main_program(pic_cam1, pic_cam2, pic_cam3, stage_cam1, stage_cam2, stage_cam3):
    app = QApplication(sys.argv)
    main_win = MainWindow(pic_cam1=pic_cam1, pic_cam2=pic_cam2, pic_cam3=pic_cam3, stage_cam1=stage_cam1, stage_cam2=stage_cam2, stage_cam3=stage_cam3)
    main_win.show()
    sys.exit(app.exec())
def inital():
    ...
    process1 = Process(target = main_program, args=(queue_pic_cam1, queue_pic_cam2, queue_pic_cam3, stage_cam1, stage_cam2, stage_cam3, ))
    process1.start()

    process2 = Process(target = camera_Basler_multi, args=(queue_pic_cam1, queue_pic_cam2, queue_pic_cam3, stage_cam1, stage_cam2, stage_cam3, ))
    process2.start()
